  ...
  toast: function () {
    ...
    if (that.data.addr == '') {
      ...
      if(that.data.select==true){
        ...
        bean.goodsId = that.data.goodlist[0].goodsId
        ...
        success: function (res) {
          ...
          if(res.data.code==0){
            ...
            var payorderamount = res.data.order.needPayMoney
                  ...
                  wx.request({
                    ...
                    success: function (res) {
                      ...
                      wx.requestPayment({
                        ...
                        success: function (res) {
                          // 消息推送
                          util.sendMsg(pay.package, orderId, payordertime, ordername, payorderamount)
                          wx.showToast({
                            title: '支付成功',
                            icon: 'success',
                            duration: 2000
                          ...
                          orderparms.paymoney = payorderamount
                          wx.request({
                            ...
                            success: function (res) {
                                if(res.data.code==0){
                                  ...
                                  if (wx.getStorageSync('isAgent')!=null){
                                    ...
                                    fenrunParm.monetary = payorderamount
